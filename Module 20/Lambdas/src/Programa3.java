 ...
 * Por isso foi possível utilizar a expressão lambda que passa uma string como parâmetro
 * e não retorna nada.
 * 
 * - A função sort, espera receber dois parâmetros do tipo string como entrada e retorna
 * um inteiro. Por isso foi possível passar a expressão lambda informando as duas strings,
 * s1 e s2 e utilizando a classe Integer.compare que retorna um inteiro.
 */
